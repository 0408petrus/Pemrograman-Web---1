...
<head>
   ...
   <title>Elste: Class Package</title>
...
<section class="packages">
   ...
   <h1 class="heading-title">top classes</h1>
   ...
   <div class="box">
      ...
      <div class="box">
         ...
         <div class="content">
            <h3>Science</h3>
            <p>Biology, Physics, Chemistry, we have everything you need!</p>
            <a href="book.php" class="btn">register now</a>
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            <h3>Sport</h3>
            <p>Play with your own team or become a shining athlete!</p>
            <a href="book.php" class="btn">register now</a>
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            <h3>Music</h3>
            <p>A producer, a singer, a composer, you can be anything</p>
            <a href="book.php" class="btn">register now</a>
         </div>
      </div>
